...
function ANIMATION0()
    ...
    Turn(rloarm, y_axis, math.rad(-30), math.rad(100))
    ...
    Turn(lloarm, z_axis, math.rad(-25), math.rad(100))
    ...
    Turn(luparm, y_axis, math.rad(40), math.rad(100))
    Turn(head, x_axis, math.rad(-20), math.rad(90))
    Turn(rloarm, z_axis, math.rad(-80), math.rad(100))
    ...
    Turn(rloarm, z_axis, math.rad(-60), math.rad(80))
    Turn(rloarm, y_axis, math.rad(15), math.rad(80))
